  ...
  methods: {
    ...
    onSubmit(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */].pages.addhy(this.formwx).then(data => {
            //   console.log(data);
            this.getdata();
    ...
    //获取数据
    getdata() {
      __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */].pages.hyList(this.filters).then(data => {
        console.log(data);
        this.tableData = data.data.data;
        this.handler.total = data.data.total;
        this.listLoading = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" 操作页面")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("广告主行业")])], 1)], 1), _vm._v(" "), _c('el-form', {
    ref: "formwx",
    staticStyle: {
      "width": "400px"
    },
    ...
    model: {
      value: (_vm.formwx.industry),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "industry", $$v)
      },
      expression: "formwx.industry"
    }
