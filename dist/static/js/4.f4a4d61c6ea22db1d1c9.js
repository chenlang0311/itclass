...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    //获取数据
    getdata() {
      __WEBPACK_IMPORTED_MODULE_2__api__["a" /* default */].pages.wxList(this.filters).then(data => {
        console.log(data);
        this.tableData = data.data.data;
        this.handler.total = data.data.total;
        this.listLoading = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" 操作页面")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("微信账号")])], 1)], 1), _vm._v(" "), _c('el-form', {
    ref: "formwx",
    staticStyle: {
      "width": "400px"
    },
    ...
    model: {
      value: (_vm.formwx.sex),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "sex", $$v)
      },
      expression: "formwx.sex"
    }
    ...
    model: {
      value: (_vm.formwx.age),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "age", _vm._n($$v))
      },
      expression: "formwx.age"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "所在城市",
    ...
    model: {
      value: (_vm.formwx.city),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "city", $$v)
      },
      expression: "formwx.city"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "使用机型",
    ...
    model: {
      value: (_vm.formwx.phone_type),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "phone_type", $$v)
      },
      expression: "formwx.phone_type"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "订阅的公众号",
    ...
    attrs: {
      "placeholder": "请输入订阅的公众号(用逗号隔开)"
    },
    model: {
      value: (_vm.formwx.sub_weixin),
      callback: function($$v) {
        _vm.$set(_vm.formwx, "sub_weixin", $$v)
      },
      expression: "formwx.sub_weixin"
    }
