<template>
<div class="operate" style="min-width:900px">
          <div class="crumbs">
  ...
  <!-- <el-collapse-item title="微信账号" name="1" > -->
    <!-- <div></div> -->
...
<div style="float:left;margin-top:-600px;margin-left:450px;">
    <el-table :data="tableData" border style="" ref="multipleTable" > 
...
<!-- </el-collapse-item> -->
  ...
  <!-- <el-collapse-item title="订阅号 " name="2"> 
    <div style="width:400px;float:left;"><el-upload
  class="upload-demo"
  drag
  ...
  <div class="el-upload__tip" slot="tip" style="font-size:28px;margin-top:40px;">文件直接上传，单个在右边添加</div>
</el-upload></div>
    <div style="width:400px;float:left;margin-left:50px;"><el-form ref="form" :model="form" label-width="110px">
   <el-form-item label="订阅号账号">
    <el-input v-model="form.name"></el-input>
  </el-form-item>
     <el-form-item label="订阅号名称">
    <el-input v-model="form.name"></el-input>
  </el-form-item>
       <el-form-item label="账号类型(行业)">
    <el-input v-model="form.name"></el-input>
  <el-form-item>
  ...
  <!-- <el-collapse-item title="广告主行业" name="3" >
  <el-table border>  <el-table-column label="行业名称" prop="adress">
        </el-table-column>
