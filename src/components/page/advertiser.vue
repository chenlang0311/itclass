<template>
  <div class="table">
    ...
    <el-table :data="tableData" border style="min-width:1130px;" ref="multipleTable" @cell-click="linkme" class="ad">
      ...
      <el-table-column label="广告主" >
            ...
            <el-table-column prop="t_weixin_account.t_weixin_industry.industry" label="广告主行业"></el-table-column>
              <!-- <el-table-column prop="t_weixin_account.t_weixin_industry.company" label="广告主所属公司"></el-table-column>       -->
      </el-table-column>
